...
**Miriam Cristina Alves de Jesus** : Wireframes(pesquisa, agendamento de serviços, processos de pagamento, avaliação, notificações e sair). Descrição do template e da iconografia.
